...
<%@include file="compoment/allcss.jsp"%>
...
<body>
	<%@include file="compoment/navbar.jsp"%>
	...
	<div class="container p-2">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/one.jpg" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/two.jpg" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/three.jpg" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-ca<%-- 	</c:if> --%>rd">
					<div class="card-body text-center">
						<img src="img/four.jpg" width="250px" height="300px">
