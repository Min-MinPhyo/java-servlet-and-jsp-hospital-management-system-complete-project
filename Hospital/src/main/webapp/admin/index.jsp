...
<body>
	...
	<p class="text-center fs-3 text-info">Doctor Dashboard</p>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="../addSpecialist" method="post">
						...
						<div class="form-group">
							<label>Enter your Specialist Name</label> <input type="text"
								name="specName" class="form-control">
						</div>

						<div class="text-center mt-3">
							<button class="btn btn-success w-50" type="submit">Add
								Specialist</button>
						</div>
