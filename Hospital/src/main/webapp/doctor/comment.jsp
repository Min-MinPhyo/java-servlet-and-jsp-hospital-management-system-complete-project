...
<body>
	...
	<div class="container-fluid backImg">
		<p class="text-center fs-2 text-white-50"></p>
	...
	<div class="container p-3">
		<div class="row">
			...
			<div class="card paint-card">
			<div class="card-body">
			<p class="text-center text-success fs-3">Comment Box</p>
			...
			<input type="text" name="" readonly value="<%=ap.getFullName() %>" class="form-control">
			</div>
			...
			<div class="col-md-6">
			<label>Age</label>
			<input type="text" name="" readonly value="<%=ap.getAge() %>"  class="form-control">
			</div>
			...
			<div class="col-md-6">
			<label>Ph No</label>
			<input type="text" name="" readonly  value="<%=ap.getPhNo() %>" class="form-control">
			</div>
			...
			<label>Comment</label>
			<textarea name="comm" required class="from-control" rows="3" cols="" ></textarea>
			</div>
			...
			<button class="btn btn-primary mt-3 col-md-6 offset-md-3">Submit</button>
